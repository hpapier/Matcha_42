      ...
      <div id='lgo-sign-in'>
        ...
        <div id='lgo-sign-in-box-2'>
          <div id='lgo-sign-in-box-2-day'>
            <select id='lgo-sign-in-box-2-day-select'>
              <option value='no-value' selected hidden>Jour</option>
              {this.dayOption()}
            </select>
          </div>
          <div id='lgo-sign-in-box-2-month'>
            <select id='lgo-sign-in-box-2-month-select'>
              <option value='no-value' selected hidden>Mois</option>
              {this.monthOption()}
            </select>
          </div>
          <div id='lgo-sign-in-box-2-year'>
            <select id='lgo-sign-in-box-2-year-select'>
              <option value='no-value' selected hidden>Année</option>
              {this.yearOption()}
            </select>
          </div>
        </div>
        ...
        <div id='lgo-sign-in-box-3'>
          <div id='lgo-sign-in-box-3-genre'>
            <select id='lgo-sign-in-box-3-genre-select'>
              <option selected hidden>Genre</option>
              <option className='lgo-sign-in-box-3-genre-select-option'>Homme</option>
              <option className='lgo-sign-in-box-3-genre-select-option'>Femme</option>
            </select>
          </div>
          <div id='lgo-sign-in-box-3-interest'>
            <select id='lgo-sign-in-box-3-interest-select'>
              <option selected hidden>Intéressé par..</option>
              <option className='lgo-sign-in-box-3-interest-select-option'>Homme</option>
              <option className='lgo-sign-in-box-3-interest-select-option'>Femme</option>
              <option className='lgo-sign-in-box-3-interest-select-option'>Homme et Femme</option>
            </select>
          </div>
        </div>
